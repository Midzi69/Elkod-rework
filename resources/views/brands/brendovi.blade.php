...
<!-- Mirrored from www.elkod.rs/brendovi.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Dec 2021 11:38:04 GMT -->
<head>
  <meta charset="utf-8">
      ...
      <div class="container">
        ...
        @foreach($brands as $brand)
          <div class="col-lg-3 col-md-6 col-xs-6  content-item" data-aos="fade-up">
             ...
             <div class="pic"><img src="{{ asset('storage/' . $brand->picture) }}" class="img-fluid" alt="">
             </div>
          </div>
        @endforeach
...
<!-- Mirrored from www.elkod.rs/brendovi.php by HTTrack Website Copier/3.x [XR&CO'2014], Fri, 17 Dec 2021 11:38:07 GMT -->
</html>